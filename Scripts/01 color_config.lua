local defaultConfig = {
	...
	difficulty = {
		Difficulty_Beginner	= "#3fb2ff",		-- light blue
		Difficulty_Easy		= "#50e043",		-- green
		Difficulty_Medium	= "#f7c80e",		-- yellow
		Difficulty_Hard		= "#f73636",		-- red
		Difficulty_Challenge= "#c24efc",	-- light blue
		Difficulty_Edit 	= "#cccccc",	-- pale blue
		Difficulty_Couple	= "#ed0972",			-- hot pink
		Difficulty_Routine	= "#ff9a00",			-- orange
		Beginner	= "#3fb2ff",		
		Easy		= "#50e043",		-- green
		Medium		= "#f7c80e",		-- yellow
		Hard		= "#f73636",		-- red
		Challenge 	= "#c24efc",	-- Purple
		Edit 		= "#cccccc",	-- gray
	...
	difficultyDark = {
		Difficulty_Beginner = "#035069",
		Difficulty_Easy     = "#067D00",
		Difficulty_Medium   = "#A66F00",
		Difficulty_Hard     = "#A80000",
		Difficulty_Challenge= "#83018C",
		Difficulty_Edit     = "#282828"
	},
...
function getDarkDifficultyColor(diff)
	return color(colorConfig:get_data().difficultyDark[diff]) or color("#ffffff")
end
